...
INSERT INTO "work_order_service_status_history" ("id", "work_order_service_id", "status", "changed_by_user_id", "note", "changed_at") VALUES
  ('40000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'APROVADO', 'a0000000-0000-0000-0000-000000000003', 'Serviço aprovado pelo técnico para iniciar execução', NOW() - INTERVAL '2 days'),
  ('40000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001', 'EM_EXECUCAO', 'a0000000-0000-0000-0000-000000000003', 'Início do serviço de revisão completa', NOW() - INTERVAL '1 day'),
  ('40000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000002', 'APROVADO', 'a0000000-0000-0000-0000-000000000004', 'Cliente autorizou alinhamento e balanceamento', NOW() - INTERVAL '2 days'),
  ('40000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000007', 'APROVADO', 'a0000000-0000-0000-0000-000000000004', 'Óleo aprovado para troca após revisão', NOW() - INTERVAL '9 days'),
  ('40000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000007', 'FINALIZADO', 'a0000000-0000-0000-0000-000000000004', 'Serviço de óleo concluído com sucesso', NOW() - INTERVAL '8 days'),
  ('40000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000008', 'APROVADO', 'a0000000-0000-0000-0000-000000000004', 'Alinhamento aprovado para execução', NOW() - INTERVAL '9 days'),
  ('40000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000008', 'FINALIZADO', 'a0000000-0000-0000-0000-000000000004', 'Alinhamento finalizado, veículo pronto', NOW() - INTERVAL '7 days');
