...
INSERT INTO "work_order_service_status_history" ("id", "work_order_service_id", "status", "changed_by_user_id", "note", "changed_at") VALUES
  ('50000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'PENDENTE', 'a0000000-0000-0000-0000-000000000002', 'Serviço criado', NOW() - INTERVAL '3 days'),
  ('50000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001', 'EM_EXECUCAO', 'a0000000-0000-0000-0000-000000000003', 'Iniciando execução', NOW() - INTERVAL '1 day'),
  ('50000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'PENDENTE', 'a0000000-0000-0000-0000-000000000002', 'Serviço criado', NOW() - INTERVAL '1 day'),
  ('50000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000006', 'PENDENTE', 'a0000000-0000-0000-0000-000000000002', 'Serviço criado', NOW() - INTERVAL '7 days'),
  ('50000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000006', 'EM_EXECUCAO', 'a0000000-0000-0000-0000-000000000003', 'Iniciando execução', NOW() - INTERVAL '5 days'),
  ('50000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000006', 'FINALIZADO', 'a0000000-0000-0000-0000-000000000003', 'Serviço concluído', NOW() - INTERVAL '3 days'),
  ('50000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000007', 'PENDENTE', 'a0000000-0000-0000-0000-000000000002', 'Serviço criado', NOW() - INTERVAL '10 days'),
  ('50000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000007', 'FINALIZADO', 'a0000000-0000-0000-0000-000000000004', 'Serviço concluído', NOW() - INTERVAL '7 days');
